import { formatLabel, getScoreColor, getScoreLabel } from "../utils/toxicity";
    ...
    <div className="group relative">
      <div className="flex items-center justify-between mb-1.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className={`px-2.5 py-0.5 text-xs font-semibold rounded-full ${safetyLabel.bg} ${safetyLabel.color}`}
          >
